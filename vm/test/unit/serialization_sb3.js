...
const commentsSB3ProjectPath = path.resolve(__dirname, '../fixtures/comments.cdc');
const commentsSB3NoDupeIds = path.resolve(__dirname, '../fixtures/comments_no_duplicate_id_serialization.cdc');
