...
class RenderedTarget extends Target {
     ...
     * @return {RenderedTarget} New clone.
     */
    duplicate (isUseForAddDevice = false) {
        return this.sprite.duplicate(isUseForAddDevice).then(newSprite => {
