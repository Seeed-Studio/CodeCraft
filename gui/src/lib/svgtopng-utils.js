...
var prepareSvg = function (el, options, done) {
  requireDomNode(el);
...
var svgAsDataUri = function (el, options, done) {
  requireDomNode(el);
...
var svgAsPngUri = function (el, options, done) {
  requireDomNode(el);
...
var download = function (name, uri, options) {
