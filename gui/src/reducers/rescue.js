...
const RESCUE_MODAL_ELFBOT_DOWN_BIN_SETP1 = 'RESCUE_MODAL_ELFBOT_DOWN_BIN_SETP1';
const RESCUE_MODAL_ELFBOT_DOWN_BIN_SETP2 = 'RESCUE_MODAL_ELFBOT_DOWN_BIN_SETP2';
const RESCUE_MODAL_ELFBOT_DOWN_BIN_SETP3 = 'RESCUE_MODAL_ELFBOT_DOWN_BIN_SETP3';

const RESCUE_MODAL_ELFBOT_UPGRADE_INIT = 'RESCUE_MODAL_ELFBOT_UPGRADE_INIT';
const RESCUE_MODAL_ELFBOT_UPGRADING = 'RESCUE_MODAL_ELFBOT_UPGRADING';
const RESCUE_MODAL_ELFBOT_UPGRADE_SUCC = 'RESCUE_MODAL_ELFBOT_UPGRADE_SUCC';
const RESCUE_MODAL_ELFBOT_UPGRADE_FAIL = 'RESCUE_MODAL_ELFBOT_UPGRADE_FAIL';
