...
import ModalComponent from '../components/modal-special/modal.jsx';
...
class Modal extends React.Component {
    ...
    render () {
        return <div onClick={this.props.onClick} onKeyDown={this.props.onKeyDown}><ModalComponent {...this.props} /></div>;
    }
}
