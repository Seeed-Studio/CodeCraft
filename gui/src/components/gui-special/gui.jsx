...
import MenuBar from '../menu-bar-special/menu-bar.jsx';
...
import MicroCourse from '../../containers/micro-course.jsx';
import ArduinoMonitor from '../../components/arduino-monitor/arduino-monitor.jsx';
...
import EdgeimpulseModal from '../edgeimpulse-modal/edgeimpulse-modal.jsx';
        ...
        return isPlayerOnly ? (
            ...
            >
                ...
                >
                    ...
                    {
                        edgeImpulseModalVisible&&<EdgeimpulseModal vm={vm}/>
                    }
                    {
...
const mapStateToProps = state => ({
    ...
    edgeImpulseModalVisible: state.scratchGui.modals.edgeImpulseModal,
