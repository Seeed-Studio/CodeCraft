...
class ProjectList extends React.Component {
    ...
    handleLoadMore() {
        ...
        const { totalCount, projectBasicInfoList } = this.state;
        if (projectBasicInfoList.length < totalCount) {
            this.handleSearchProjectBasicInfoList({
    ...
    handleProjectSelect(projectUUID) {
        if (this.props.isProjectSaved) {
            ...
            this.props.onSetRemindSaveType(`openProject:${projectUUID}`);
        }
    }
                    ...
                    <Box className={styles.middleGroup}>
                        ...
                        >
                            <CourseSearch
                                ...
                                placeholder={intl.formatMessage(messages.searchProjects)}
                            />
                        </MenuBarItemTooltip>
                    </Box>
