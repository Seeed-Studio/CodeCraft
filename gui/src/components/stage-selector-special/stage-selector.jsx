    ...
    return (
        <Box
            className={classNames(styles.stageSelector,
                stageSize == 'small' ? styles.backdropWrapperSmall : styles.backdropWrapperLarge
            )}
        ...
        >
            ...
            <div className={classNames(styles.costumeCanvas, {
                [styles.isSelected]: selected,
                // [styles.raised]: raised || dragOver,
                // [styles.receivedBlocks]: receivedBlocks
            },
                stageSize == 'small' ? styles.canvasPicSmall : styles.canvasPicLarge
            )} onClick={onClick}>
                {url ? (
                    <img
                        className={styles.costumeCanvasPic}
                        src={url}
                    />
                ) : null}
                <img src={require('./icon_addbg.png')} alt="" className={styles.addBg} onClick={onHandleClickBackdrop} />
            </div>
