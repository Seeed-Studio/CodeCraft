...
import Input from '../forms/input-label.jsx';
import BufferedInputHOC from '../forms/buffered-input-hoc.jsx';
import Dial from './dial.jsx';

import styles from './direction-picker.css';

import allAroundIcon from './icon--all-around.png';
import leftRightIcon from './icon--left-right.png';
import dontRotateIcon from './icon--dont-rotate.png';
    ...
    // >
        ...
        >
            <BufferedInput
                ...
                inputwrapclassname={styles.directionInputWrap}
                inputlabelclassname={styles.directionInputLabel}
                small
