...
goog.provide('Blockly.FieldDropdownMulti');
 ...
 * @constructor
 */
Blockly.FieldDropdownMulti = function (menuGenerator, opt_validator) {
  this.menuGenerator_ = menuGenerator;
  this.trimOptions_();
  var firstTuple = this.getOptions()[0];
  // Call parent's constructor.
  Blockly.FieldDropdownMulti.superClass_.constructor.call(this, '',
    opt_validator);
  this.addArgType('dropdown_multi');
};
goog.inherits(Blockly.FieldDropdownMulti, Blockly.Field);

Blockly.FieldDropdownMulti.fromJson = function(element) {
  return new Blockly.FieldDropdown(element['options']);
};
/**
 * Horizontal distance that a checkmark overhangs the dropdown.
 */
Blockly.FieldDropdownMulti.CHECKMARK_OVERHANG = 25;

/**
 * Mouse cursor style when over the hotspot that initiates the editor.
 */
Blockly.FieldDropdownMulti.prototype.CURSOR = 'default';

/**
 * Closure menu item currently selected.
 * @type {?goog.ui.MenuItem}
 */
Blockly.FieldDropdownMulti.prototype.selectedItem = null;
 ...
 * @private
 */
Blockly.FieldDropdownMulti.prototype.value_ = '';
 ...
 * @private
 */
Blockly.FieldDropdownMulti.prototype.imageElement_ = null;
 ...
 * @private
 */
Blockly.FieldDropdownMulti.prototype.imageJson_ = null;

/**
 * Install this dropdown on a block.
 */
Blockly.FieldDropdownMulti.prototype.init = function () {
  if (this.fieldGroup_) {
  ...
  Blockly.FieldDropdownMulti.superClass_.init.call(this);
 ...
 * @private
 */
Blockly.FieldDropdownMulti.prototype.showEditor_ = function () {
  ...
  for (var i = 0; i < options.length; i++) {
    ...
    var valueList = this.value_.split('|');
    var checked = false;
    for (var x = 0, v; v = valueList[x]; x++) {
      if (value == v) {
        checked = true;
        break;
      }
    ...
    // if (checked) {
      ...
      // this.selectedItem.push[menuItem];
    // }
  }
 ...
 */
Blockly.FieldDropdownMulti.prototype.onHide = function () {
 ...
 */
Blockly.FieldDropdownMulti.prototype.onItemSelected = function (menu, menuItem) {
 ...
 * @private
 */
Blockly.FieldDropdownMulti.prototype.trimOptions_ = function () {
 ...
 */
Blockly.FieldDropdownMulti.prototype.isOptionListDynamic = function () {
 ...
 */
Blockly.FieldDropdownMulti.prototype.getOptions = function () {
 ...
 */
Blockly.FieldDropdownMulti.prototype.getValue = function () {
  return this.value_;
};
 ...
 */
Blockly.FieldDropdownMulti.prototype.setValue = function (newValue) {

  var newValueList = newValue.split('|');
  var valueList = this.value_.split('|');

  while(true){
    var nullStrIdx = valueList.indexOf('');
    if(nullStrIdx === -1) break;
    valueList.splice(nullStrIdx, 1);
  }


  var idx = valueList.indexOf(newValue) ;
  ...
  for(var j = 0 ;j<valueList.length;j++){
    for (var i = 0; i < options.length; i++) {
      if (options[i][1] == valueList[j]) {
        var content = options[i][0];
        if (typeof content == 'object') {
          this.imageJson_ = content;
          text.push(content.alt);
        } else {
 ...
 */
Blockly.FieldDropdownMulti.prototype.setText = function (text) {
 ...
 */
Blockly.FieldDropdownMulti.prototype.positionArrow = function (x) {
  if (!this.arrow_) {
    return 0;
  }
 ...
 */
Blockly.FieldDropdownMulti.prototype.dispose = function () {
  // this.selectedItem = null;
  Blockly.WidgetDiv.hideIfOwner(this);
  Blockly.FieldDropdownMulti.superClass_.dispose.call(this);
};


Blockly.Field.register('field_dropdown_multi', Blockly.FieldDropdownMulti);
