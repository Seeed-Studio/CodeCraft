...
// codecraft
goog.require('Blockly.FieldLedmatrix');
goog.require('Blockly.FieldElfLedmatrix');
...
goog.require('Blockly.FieldIRRemoteControl');
goog.require('Blockly.FieldLegservoSet');


goog.require('Blockly.FieldMpythonmatrix');

// haloboad
goog.require('Blockly.FieldColorBar');
goog.require('Blockly.FieldSuperenergyRing');
...
// 点击扩展打开扩展弹窗，映射到gui
Blockly.extensionDivClick = function() {
  console.log('extensionDivClick');
}