...
Blockly.Trashcan.prototype.TRASH_TOP = 'trash_top.svg';
// Blockly.Trashcan.prototype.TRASH_TOP_WIDTH = 51;
// Blockly.Trashcan.prototype.TRASH_TOP_HEIGHT = 17;
Blockly.Trashcan.prototype.TRASH_TOP_WIDTH = 38;
Blockly.Trashcan.prototype.TRASH_TOP_HEIGHT = 11;
Blockly.Trashcan.prototype.TRASH_BODY = 'trash_body.svg';
// Blockly.Trashcan.prototype.TRASH_BODY_WIDTH = 38;
// Blockly.Trashcan.prototype.TRASH_BODY_HEIGHT = 39;
Blockly.Trashcan.prototype.TRASH_BODY_WIDTH = 25;
Blockly.Trashcan.prototype.TRASH_BODY_HEIGHT = 29;
...
Blockly.Trashcan.prototype.createDom = function () {
  ...
  */
  ...
  var body = Blockly.utils.createSvgElement('image',
    ...
    // },
    {
      'width': this.TRASH_BODY_WIDTH,
      'x': 0,
      'height': this.TRASH_BODY_HEIGHT,
      'y': 0,
    },
    this.svgGroup_);
  body.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href',
    this.workspace_.options.pathToMedia + this.TRASH_BODY);
  ...
  this.svgLid_ = Blockly.utils.createSvgElement('image',
    ...
    // },
    {
      'width': this.TRASH_TOP_WIDTH,
      'x': -(this.TRASH_TOP_WIDTH - this.TRASH_BODY_WIDTH) / 2,
      'height': this.TRASH_TOP_HEIGHT,
      'y': -this.TRASH_TOP_HEIGHT + 2,
    },
    this.svgGroup_);
  this.svgLid_.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href',
    this.workspace_.options.pathToMedia + this.TRASH_TOP);
...
Blockly.Trashcan.prototype.getClientRect = function () {
  ...
  var left = trashRect.left + this.SPRITE_LEFT_ - this.MARGIN_HOTSPOT_ + 10;
  var top = trashRect.top + this.SPRITE_TOP_ - this.MARGIN_HOTSPOT_ - 20;
  var width = this.WIDTH_ + 2 * this.MARGIN_HOTSPOT_ - 30;
  var height = this.LID_HEIGHT_ + this.BODY_HEIGHT_ + 2 * this.MARGIN_HOTSPOT_ - 40;
...
Blockly.Trashcan.prototype.animateLid_ = function () {
  ...
  this.svgLid_.setAttribute('transform', 'rotate(' +
    ...
    (this.workspace_.RTL ? 4 : this.TRASH_TOP_WIDTH - 4) + ',' +
    // (this.LID_HEIGHT_ - 2) + ')');
    (0) + ')');
