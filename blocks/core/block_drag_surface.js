...
Blockly.BlockDragSurfaceSvg.prototype.setBlocksAndShow = function(blocks) {
  ...
  // Blockly.utils.addClass(/** @type {!Element} */(this.blocks.firstChild),
  //   'blocklyDraggingPath');
...
Blockly.BlockDragSurfaceSvg.prototype.clearAndHide = function(opt_newSurface) {
  // this.blocks.firstChild.setAttribute('stroke', this.currentBlockStokeColor);
  // this.blocks.firstChild.setAttribute('stroke-width',1);
  // this.blocks.firstChild.removeClass('blocklyDraggingPath')
  // Blockly.utils.removeClass(/** @type {!Element} */(this.blocks.firstChild),
  //   'blocklyDraggingPath');
