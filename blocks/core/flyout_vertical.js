...
Blockly.VerticalFlyout.prototype.CHANGED_WIDTH = 250;
...
Blockly.VerticalFlyout.prototype.createDom = function (tagName) {
  ...
  */
  ...
  // var clipPath = Blockly.utils.createSvgElement('path',
...
Blockly.VerticalFlyout.prototype.position = function () {
  ...
  // flyout宽度改变后，改变浏览器窗口大小时应该使用改变后的宽度
  this.svgGroup_.setAttribute("width", this.CHANGED_WIDTH);
  ...
  if (this.scrollbar_) {
    ...
    // this.scrollbar_.setOrigin(x + 5, y);
    this.scrollbar_.setOrigin((this.CHANGED_WIDTH - 136.5), y);
