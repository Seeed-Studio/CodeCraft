...
Blockly.WorkspaceCommentSvg.prototype.createEditor_ = function() {
  ...
  this.textarea_.style.marginTop = (Blockly.ScratchBlockComment.TEXTAREA_OFFSET / 2) + 'px';
  this.textarea_.style.paddingLeft = (Blockly.ScratchBlockComment.TEXTAREA_OFFSET) + 'px';
  this.textarea_.style.paddingRight = (Blockly.ScratchBlockComment.TEXTAREA_OFFSET) + 'px';
  this.textarea_.style.paddingBottom = 0;
...
Blockly.WorkspaceCommentSvg.prototype.resizeComment_ = function() {
  ...
  this.textarea_.style.height =
      (this.height_ - doubleBorderWidth - topOffset) + 'px';
  this.textarea_.style.overflow = 'scroll';
};
