...
Blockly.BlockSvg = function(workspace, prototypeName, opt_id) {
  ...
  /** @type {SVGElement} */
  this.svgShadowPath_ = Blockly.utils.createSvgElement('path',
    { 'class': 'blocklyShadowPath blocklyBlockBackground' },
    this.svgGroup_);
...
Blockly.BlockSvg.prototype.setGlowStack = function(isGlowingStack) {
  ...
  // if (this.isGlowingStack_ && !(svg.classList.value.indexOf('blocklyRunning') > -1)) {
  //   Blockly.utils.addClass(
  //     /** @type {!Element} */
  //     (svg), 'blocklyRunning');
  // } else if (!this.isGlowingStack_ && (svg.classList.value.indexOf('blocklyRunning') > -1)) {
...
Blockly.BlockSvg.prototype.setDragging = function(adding) {
  if (adding) {
    ...
    Blockly.utils.addClass(/** @type {!Element} */(this.workspace.toolbox_.categoryMenu_.trashContainer),
      'trashContainerShow');
    ...
    Blockly.utils.removeClass(
        /** @type {!Element} */ (this.svgGroup_), 'blocklyDragging');
    Blockly.utils.removeClass(/** @type {!Element} */(this.workspace.toolbox_.categoryMenu_.trashContainer),
      'trashContainerShow');
  }
  // Recurse through all blocks attached under this one.
...
Blockly.BlockSvg.prototype.updateDisabled = function () {
  if (this.disabled) {
    this.setColour("#bcc0c9", "#bcc0c9", "#a2a7b2");
  }
};
...
Blockly.BlockSvg.prototype.addSelect = function() {
  ...
  // var stackGlowFilterId = this.workspace.options.stackGlowFilterId || 'blocklyStackGlowFilter';
  // this.svgGroup_.setAttribute('filter', 'url(#' + stackGlowFilterId + ')');
};

Blockly.BlockSvg.prototype.addSelectAddFilter = function () {
  var stackGlowFilterId = this.workspace.options.stackGlowFilterId || 'blocklyStackGlowFilter';
  this.svgGroup_.setAttribute('filter', 'url(#' + stackGlowFilterId + ')');
};
...
Blockly.BlockSvg.prototype.removeSelect = function() {
  Blockly.utils.removeClass(
      /** @type {!Element} */ (this.svgGroup_),  'blocklySelected');
  // var stackGlowFilterId = this.workspace.options.stackGlowFilterId || 'blocklyStackGlowFilter';
  // this.svgGroup_.removeAttribute('filter', 'url(#' + stackGlowFilterId + ')');
};
Blockly.BlockSvg.prototype.removeSelectRemoveFilter = function () {
  var stackGlowFilterId = this.workspace.options.stackGlowFilterId || 'blocklyStackGlowFilter';
  this.svgGroup_.removeAttribute('filter', 'url(#' + stackGlowFilterId + ')');
};
/**
...
Blockly.BlockSvg.prototype.setDeleteStyle = function(enable) {
  if (enable) {
    Blockly.utils.addClass(/** @type {!Element} */(this.workspace.toolbox_.categoryMenu_.trashCoverIcon),
      'trashCoverOpen');
    // Blockly.utils.addClass(/** @type {!Element} */ (this.svgGroup_),
    //     'blocklyDraggingDelete');
  } else {
    Blockly.utils.removeClass(/** @type {!Element} */(this.workspace.toolbox_.categoryMenu_.trashCoverIcon),
      'trashCoverOpen');
    // Blockly.utils.removeClass(/** @type {!Element} */ (this.svgGroup_),
    //     'blocklyDraggingDelete');
  }
